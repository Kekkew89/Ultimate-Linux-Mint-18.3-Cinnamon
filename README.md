...
Or you can use the terminal and the git command
	...
	git clone https://github.com/Kekkew89/Ultimate-Linux-Mint-18.3-Cinnamon
...
They are about an older version of Linux Mint. You will see many things have stayed the same. No need to make them again in 18.3.
